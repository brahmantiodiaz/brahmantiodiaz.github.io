...
$(document).ready(function ($) {
  ...
  $(".ts-shapes-canvas .ts-background-image").each(function () {
    var $this = $(this);
    $this.css({
      "animation-duration": Math.floor(Math.random() * 10) + 3 + "s",
    });
        ...
        el.empty()
          ...
          .append(
            "<div><span class='ts-cc-number'>" +
              ...
              " </span><span class='ts-cc-description'>Hours</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
              this.leadingZeros(data.min, 2) +
              " </span><span class='ts-cc-description'>Minutes</span></div>"
          )
          .append(
            "<div><span class='ts-cc-number'>" +
